--[[
  ...
  | (___   ___| | |_  | |  | |_ __ ___   ___ _ __   __ _
   \___ \ / _ \ |  _| | |  | | '__| \ \ / / | '_ \ / _` |
   ____) |  __/ | |   | |__| | |  | |\ V /| | | | | (_| |
  |_____/ \___|_|_|   |_____/|_|  |_| \_/ |_|_| |_|\__, |
                                                    __/ |
                                                   |___/
...
print("BEGIN: Loading self-driving.lua")

Settings                    = {}
Settings.UseAllowedVehicles = true -- Set to true to use AllowedVehicles list.  Set to false to allow self driving on all vehicles.
...
AllowedVehicles = {
--"Example", -- To disallow a certain vehicle, put 2 dashes in front of the line.
  "MODELS",
  "TESLAX",
  "tr22", 
  "onebeast",
...
function SelfDriving:InstructionalButtonThreadSelf()
  ...
  if not NATIVE_KEYS then print("ERROR: self-driving.lua - NATIVE_KEYS not found."); return; end;
...
print("END:   Loading self-driving.lua")
